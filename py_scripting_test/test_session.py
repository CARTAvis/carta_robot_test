...
def start_and_create_session():
    session = Session.start_and_create(Chrome(), "/Users/kswang/carta_build/carta-backend/build/carta_backend", params=("/Users/kswang/set_QA_e2e_v2", "--frontend_folder", "/Users/kswang/carta_build/carta-frontend/build", "--port", "3002", "--debug_no_auth"))
    session.set_view_area(800, 800)
    img0 = session.open_image(image_file_0)
    img0.set_channel(88)
    img0.set_colormap('tab10')
