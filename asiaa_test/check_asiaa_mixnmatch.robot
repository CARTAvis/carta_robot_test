...
Access ASIAA CARTA MixNMatch And Load An Image With Dev+Dev
    ...
    Input Text    //*[@id="root"]/div/div[6]/div[1]/div/div[2]/div/div[3]/div[2]/input    HD163296_CO_2_1.fits
    Sleep    1
    Click Element    //*[@id="root"]/div/div[6]/div[1]/div/div[2]/div/div[3]/div[1]/div[1]/div/div/div[1]/div[1]/div/div[2]/div/div/div/div/div[1]/div/div
