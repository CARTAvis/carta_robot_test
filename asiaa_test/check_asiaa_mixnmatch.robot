...
Access ASIAA CARTA MixNMatch And Load An Image With Dev+Dev
    ...
    Element Should Contain    //*[@id="root"]/div/div[15]/div[2]/div/div[1]/div[1]/div[1]/ul[1]/li/span    HD163296_CO_2_1.fits
    Element Attribute Value Should Be    //*[@id="root"]/div/div[15]/div[2]/div/div[1]/div[3]/div[2]/div/div/div/div[2]/div[2]/div/div/div/input    Value    -0.020490288427972802
