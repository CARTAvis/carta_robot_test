...
Match Images Spatially And Spectrally
    ...
    Click Element At Coordinates    //*[@id="root"]/div/div[12]/div[2]/div/div[3]/div[5]/div[2]/div[2]/div/div/div[2]/div[1]/div[1]/div[1]    -50    0
    Mouse Over    ${VIEWER_DIV}
    Mouse Out    ${VIEWER_DIV}
    Sleep    1
    ...
    Sleep    1
    Click Element    //*[@id="root"]/div/div[12]/div[2]/div/div[3]/div[5]/div[2]/div[2]/div/div/div[2]/div[2]
    Sleep    1
    Mouse Over    ${VIEWER_DIV}
    Mouse Out    ${VIEWER_DIV}
    Sleep    1
