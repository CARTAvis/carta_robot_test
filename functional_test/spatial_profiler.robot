...
Cursor Spatial Profile
    ...
    ${spatial_profiler_info_1}=    Get Text    //*[@id="root"]/div/div[16]/div[2]/div/div[3]/div[1]/div[2]/div/div/div/div[1]/div[3]/div
    ...
    Capture Element Screenshot    //*[@id="root"]/div/div[16]/div[2]/div/div[3]/div[1]/div[2]/div/div/div/div[1]/div[2]    initial.png
    Click Element At Coordinates    ${VIEWER_DIV}    20    20
    ${viewer_cursor_info_2}=    Get Text    ${VIEWER_CURSOR_INFO_BAR}
    ${spatial_profiler_info_2}=    Get Text    //*[@id="root"]/div/div[16]/div[2]/div/div[3]/div[1]/div[2]/div/div/div/div[1]/div[3]/div
    ...
    Capture Element Screenshot    //*[@id="root"]/div/div[16]/div[2]/div/div[3]/div[1]/div[2]/div/div/div/div[1]/div[2]    new_cursor_position.png
    ...
    Mouse Over    //*[@id="root"]/div/div[16]/div[2]/div/div[3]/div[1]/div[2]/div/div/div/div[1]/div[2]
    Element Should Contain    //*[@id="root"]/div/div[16]/div[2]/div/div[3]/div[1]/div[2]/div/div/div/div[1]/div[3]/div    Cursor    
...
Line Spatial Profile Fixed Pixel Width
    ...
    Sleep    1
    Click Element    //*[@id="root"]/div/div[16]/div[2]/div/div[3]/div[1]/div[1]/ul[2]/li[4]
    ...
    Capture Element Screenshot    //*[@id="root"]/div/div[16]/div[2]/div/div[3]/div[1]/div[2]/div/div/div/div[1]/div[2]/div/div[2]/div/canvas    check.png
    ...
    Mouse Over    //*[@id="root"]/div/div[16]/div[2]/div/div[3]/div[1]/div[2]/div/div/div/div[1]/div[2]
    Element Should Contain    //*[@id="root"]/div/div[16]/div[2]/div/div[3]/div[1]/div[2]/div/div/div/div[1]/div[3]/div    Cursor: (Offset: -5.00159e-1 deg, 4.58767e-2)
...
Line Spatial Profile Fixed Angular Width
    ...
    Mouse Over    //*[@id="root"]/div/div[16]/div[2]/div/div[3]/div[1]/div[2]/div/div/div/div[1]/div[2]
    Element Should Contain    //*[@id="root"]/div/div[16]/div[2]/div/div[3]/div[1]/div[2]/div/div/div/div[1]/div[3]/div    Cursor: (Offset: -3.3 deg, 2.6148e-4)
    Remove Files    check.png
    [Teardown]    Kill carta_backend And Close Browser
...
Polyline Spatial Profile Fixed Pixel Width
    ...
    Mouse Over    //*[@id="root"]/div/div[16]/div[2]/div/div[3]/div[1]/div[2]/div/div/div/div[1]/div[2]
    Element Should Contain    //*[@id="root"]/div/div[16]/div[2]/div/div[3]/div[1]/div[2]/div/div/div/div[1]/div[3]/div    Cursor: (Distance: 2.71726 deg, 1.28723e-2)
    Remove Files    check.png
    [Teardown]    Kill carta_backend And Close Browser
...
Polyline Spatial Profile Fixed Angular Width
    ...
    Mouse Over    //*[@id="root"]/div/div[16]/div[2]/div/div[3]/div[1]/div[2]/div/div/div/div[1]/div[2]
    Element Should Contain    //*[@id="root"]/div/div[16]/div[2]/div/div[3]/div[1]/div[2]/div/div/div/div[1]/div[3]/div    Cursor: (Distance: 1.63e+1 deg, -7.7284e-5)
    Remove Files    check.png
    [Teardown]    Kill carta_backend And Close Browser