...
Cursor Spatial Profile
    ...
    ${spatial_profiler_info_1}=    Get Text    //*[@id="root"]/div/div[14]/div[2]/div/div[3]/div[1]/div[2]/div/div/div/div[1]/div[3]/div
    ...
    Capture Element Screenshot    //*[@id="root"]/div/div[14]/div[2]/div/div[3]/div[1]/div[2]/div/div/div/div[1]/div[2]    initial.png
    Click Element At Coordinates    ${VIEWER_DIV}    20    20
    ${viewer_cursor_info_2}=    Get Text    ${VIEWER_CURSOR_INFO_BAR}
    ${spatial_profiler_info_2}=    Get Text    //*[@id="root"]/div/div[14]/div[2]/div/div[3]/div[1]/div[2]/div/div/div/div[1]/div[3]/div
    ...
    Capture Element Screenshot    //*[@id="root"]/div/div[14]/div[2]/div/div[3]/div[1]/div[2]/div/div/div/div[1]/div[2]    new_cursor_position.png
    ...
    Mouse Over    //*[@id="root"]/div/div[14]/div[2]/div/div[3]/div[1]/div[2]/div/div/div/div[1]/div[2]
    Element Should Contain    //*[@id="root"]/div/div[14]/div[2]/div/div[3]/div[1]/div[2]/div/div/div/div[1]/div[3]/div    Cursor    
