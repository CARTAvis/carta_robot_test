...
Generate All Moment Images
    [Setup]    Setup carta_backend And Open Browser To CARTA
    Load Initial Image    M17_SWex.fits
    Click Element    //*[@id="root"]/div/div[16]/div[2]/div/div[1]/div[1]/div[1]/ul[2]/li[2]/span
    Mouse Over    ${VIEWER_DIV}
    Click Element    //*[@id="SpectralProfilerButton"]
    Click Element    //*[@id="root"]/div/div[17]/div/div[1]/div[2]/div/div[1]/div[1]/div/div[2]/span[2]/a
    ...
    Element Should Contain    //*[@id="root"]/div/div[16]/div[2]/div/div[1]/div[1]/div[1]/ul[1]/li/span    M17_SWex.fits.moment.minimum_coord
    Table Cell Should Contain    //*[@id="root"]/div/div[16]/div[2]/div/div[3]/div[1]/div[2]/div[2]/div/div/div[2]/table    8    2    3.025600051880e+1 km/s
    ...
    Element Should Contain    //*[@id="root"]/div/div[16]/div[2]/div/div[1]/div[1]/div[1]/ul[1]/li/span    M17_SWex.fits.moment.minimum
    Table Cell Should Contain    //*[@id="root"]/div/div[16]/div[2]/div/div[3]/div[1]/div[2]/div[2]/div/div/div[2]/table    8    2    2.420960962772e-1 Jy/beam
    Capture Element Screenshot    ${VIEWER_DIV}    moment_10.png
    Click Element    ${ANIMATOR_PREVIOUS_BUTTON}
    Element Should Contain    //*[@id="root"]/div/div[16]/div[2]/div/div[1]/div[1]/div[1]/ul[1]/li/span    M17_SWex.fits.moment.maximum_coord
    Table Cell Should Contain    //*[@id="root"]/div/div[16]/div[2]/div/div[3]/div[1]/div[2]/div[2]/div/div/div[2]/table    8    2    3.025600051880e+1 km/s
    Capture Element Screenshot    ${VIEWER_DIV}    moment_9.png
    Click Element    ${ANIMATOR_PREVIOUS_BUTTON}
    Element Should Contain    //*[@id="root"]/div/div[16]/div[2]/div/div[1]/div[1]/div[1]/ul[1]/li/span    M17_SWex.fits.moment.maximum
    Table Cell Should Contain    //*[@id="root"]/div/div[16]/div[2]/div/div[3]/div[1]/div[2]/div[2]/div/div/div[2]/table    8    2    4.446276426315e-1 Jy/beam
    Capture Element Screenshot    ${VIEWER_DIV}    moment_8.png
    Click Element    ${ANIMATOR_PREVIOUS_BUTTON}
    Element Should Contain    //*[@id="root"]/div/div[16]/div[2]/div/div[1]/div[1]/div[1]/ul[1]/li/span    M17_SWex.fits.moment.abs_mean_dev
    Table Cell Should Contain    //*[@id="root"]/div/div[16]/div[2]/div/div[3]/div[1]/div[2]/div[2]/div/div/div[2]/table    8    2    1.477163285017e-1 Jy/beam
    Capture Element Screenshot    ${VIEWER_DIV}    moment_7.png
    Click Element    ${ANIMATOR_PREVIOUS_BUTTON}
    Element Should Contain    //*[@id="root"]/div/div[16]/div[2]/div/div[1]/div[1]/div[1]/ul[1]/li/span    M17_SWex.fits.moment.rms
    Table Cell Should Contain    //*[@id="root"]/div/div[16]/div[2]/div/div[3]/div[1]/div[2]/div[2]/div/div/div[2]/table    8    2    2.927759885788e-1 Jy/beam
    Capture Element Screenshot    ${VIEWER_DIV}    moment_6.png
    Click Element    ${ANIMATOR_PREVIOUS_BUTTON}
    Element Should Contain    //*[@id="root"]/div/div[16]/div[2]/div/div[1]/div[1]/div[1]/ul[1]/li/span    M17_SWex.fits.moment.standard_deviation
    Table Cell Should Contain    //*[@id="root"]/div/div[16]/div[2]/div/div[3]/div[1]/div[2]/div[2]/div/div/div[2]/table    8    2    1.882859319448e-1 Jy/beam
    Capture Element Screenshot    ${VIEWER_DIV}    moment_5.png
    Click Element    ${ANIMATOR_PREVIOUS_BUTTON}
    Element Should Contain    //*[@id="root"]/div/div[16]/div[2]/div/div[1]/div[1]/div[1]/ul[1]/li/span    M17_SWex.fits.moment.median_coord
    Table Cell Should Contain    //*[@id="root"]/div/div[16]/div[2]/div/div[3]/div[1]/div[2]/div[2]/div/div/div[2]/table    8    2    3.025600051880e+1 km/s
    Capture Element Screenshot    ${VIEWER_DIV}    moment_4.png
    Click Element    ${ANIMATOR_PREVIOUS_BUTTON}
    Element Should Contain    //*[@id="root"]/div/div[16]/div[2]/div/div[1]/div[1]/div[1]/ul[1]/li/span    M17_SWex.fits.moment.median
    Table Cell Should Contain    //*[@id="root"]/div/div[16]/div[2]/div/div[3]/div[1]/div[2]/div[2]/div/div/div[2]/table    8    2    2.901065945625e-1 Jy/beam
    Capture Element Screenshot    ${VIEWER_DIV}    moment_3.png
    Click Element    ${ANIMATOR_PREVIOUS_BUTTON}
    Element Should Contain    //*[@id="root"]/div/div[16]/div[2]/div/div[1]/div[1]/div[1]/ul[1]/li/span    M17_SWex.fits.moment.weighted_dispersion_coord
    Table Cell Should Contain    //*[@id="root"]/div/div[16]/div[2]/div/div[3]/div[1]/div[2]/div[2]/div/div/div[2]/table    8    2    5.907100677490e+0 km/s
    Capture Element Screenshot    ${VIEWER_DIV}    moment_2.png
    Click Element    ${ANIMATOR_PREVIOUS_BUTTON}
    Element Should Contain    //*[@id="root"]/div/div[16]/div[2]/div/div[1]/div[1]/div[1]/ul[1]/li/span    M17_SWex.fits.moment.weighted_coord
    Table Cell Should Contain    //*[@id="root"]/div/div[16]/div[2]/div/div[3]/div[1]/div[2]/div[2]/div/div/div[2]/table    8    2    3.025600051880e+1 km/s
    Capture Element Screenshot    ${VIEWER_DIV}    moment_1.png
    Click Element    ${ANIMATOR_PREVIOUS_BUTTON}
    Element Should Contain    //*[@id="root"]/div/div[16]/div[2]/div/div[1]/div[1]/div[1]/ul[1]/li/span    M17_SWex.fits.moment.integrated
    Table Cell Should Contain    //*[@id="root"]/div/div[16]/div[2]/div/div[3]/div[1]/div[2]/div[2]/div/div/div[2]/table    8    2    8.415695428848e-1 Jy/beam.km/s
    Capture Element Screenshot    ${VIEWER_DIV}    moment_0.png
    Click Element    ${ANIMATOR_PREVIOUS_BUTTON}
    Element Should Contain    //*[@id="root"]/div/div[16]/div[2]/div/div[1]/div[1]/div[1]/ul[1]/li/span    M17_SWex.fits.moment.average
    Table Cell Should Contain    //*[@id="root"]/div/div[16]/div[2]/div/div[3]/div[1]/div[2]/div[2]/div/div/div[2]/table    8    2    2.551147937775e-1 Jy/beam
...
Generate Moment Images From Unmatched Cubes
    ...
    Click Element    xpath://*[contains(text(), "Animator")]
    Click Element    ${ANIMATOR_PREVIOUS_BUTTON}
    Element Should Contain    //*[@id="root"]/div/div[16]/div[2]/div/div[1]/div[1]/div[1]/ul[1]/li/span    M17_SWex.hdf5.moment.integrated
    [Teardown]    Kill carta_backend And Close Browser
