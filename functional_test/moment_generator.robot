...
Generate All Moment Images
    ...
    Table Cell Should Contain    ${STATISTICS_WIDGET_TABLE}    11    2    3.025600051880e+1 km/s
    ${key}=    Generate Random String    8
    ...
    Table Cell Should Contain    ${STATISTICS_WIDGET_TABLE}    11    2    2.420960962772e-1 Jy/beam
    ...
    Table Cell Should Contain    ${STATISTICS_WIDGET_TABLE}    11    2    4.446276426315e-1 Jy/beam
    ...
    Table Cell Should Contain    ${STATISTICS_WIDGET_TABLE}    11    2    1.477163285017e-1 Jy/beam
    Capture Element Screenshot    ${VIEWER_DIV}    moment_7_${key}.png
    Click Element    ${ANIMATOR_PREVIOUS_BUTTON}
    Element Should Contain    ${VIEWER_TAB_TITLE}    M17_SWex.fits.moment.rms
    Table Cell Should Contain    ${STATISTICS_WIDGET_TABLE}    11    2    2.927759885788e-1 Jy/beam
    ...
    Table Cell Should Contain    ${STATISTICS_WIDGET_TABLE}    11    2    1.882859319448e-1 Jy/beam
    ...
    Table Cell Should Contain    ${STATISTICS_WIDGET_TABLE}    11    2    2.901065945625e-1 Jy/beam
    ...
    Table Cell Should Contain    ${STATISTICS_WIDGET_TABLE}    11    2    5.907100677490e+0 km/s
    ...
    Table Cell Should Contain    ${STATISTICS_WIDGET_TABLE}    11    2    8.415695428848e-1 Jy/beam.km/s
    ...
    Table Cell Should Contain    ${STATISTICS_WIDGET_TABLE}    11    2    2.551147937775e-1 Jy/beam
...
Generate Moment Images With A Custom Rest Frequency
    ...
    Double Click Element    id:numericInput-12
    Input Text    id:numericInput-12    349.4795473    clear=False
    # use the coordinate dropdown to select radio velocity as the reference 
    Click Element    css:[data-testid="moment-generator-tab"] [data-testid="spectral-profiler-coordinate-dropdown"]
    Click Element    //*[@data-testid="moment-generator-tab"]//option[contains(text(), "Radio velocity (km/s)")]
