...
Webglreport Test
    ...
    Open Browser    browser=${BROWSER}    service=executable_path=${CHROMEDRIVER_PATH}    options=add_argument("--use-gl=angle");add_argument("--ignore-gpu-blocklist");add_argument("--force-color-profile=srgb");add_argument("--enable-gpu");add_argument("--enable-webgl");add_argument("--use-angle=gl");add_argument("--disable-dev-shm-usage");add_argument("--no-sandbox")
