*** Settings ***
Documentation     Loading, appending and closing catalogs and using psrecord to 
...               monitor ram and cpu usages.
Resource          ../resource.robot

*** Test Cases ***
Load-Append-Close Catalog Mixed With Psrecord
    [Setup]    Setup carta_backend And Open Browser To CARTA
    Sleep     1
    Go To E2E QA Folder
    Load Initial Image    ${FITS_cosmos_spitzer3.6micro}
    Run psrecord    psrecord_load_append_close_catalog.png
    Sleep    0.5
...
Load-Close Catalog Votable With Psrecord
    [Setup]    Setup carta_backend And Open Browser To CARTA
    Sleep     1
    Go To E2E QA Folder
    Load Initial Image    ${FITS_cosmos_spitzer3.6micro}
    Run psrecord    psrecord_load_close_catalog_votable.png
    Sleep    0.5
    Click Element    xpath://*[contains(text(), "File")]
    Click Element    xpath://*[contains(text(), "Import catalog")]
    Wait Until Page Contains Element    ${VOTABLE_COSMOSOPTCAT}
...
Load-Close Catalog FITS With Psrecord
    [Setup]    Setup carta_backend And Open Browser To CARTA
    Sleep     1
    Go To E2E QA Folder
    Load Initial Image    ${FITS_cosmos_spitzer3.6micro}
    Run psrecord    psrecord_load_close_catalog_fits.png
    Sleep    0.5
    Click Element    xpath://*[contains(text(), "File")]
    Click Element    xpath://*[contains(text(), "Import catalog")]
    Wait Until Page Contains Element    ${FITS_COSMOSOPTCAT}
